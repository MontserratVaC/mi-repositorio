...
const RefrescoProfile = () => {
  ...
  const editar = () => {
    axios.post('http://localhost/refresco_update.php', form)
      .then(response => {
  ...
  const eliminar = (id) => {
    ...
    if (opcion) {
      axios.post('http://localhost/refresco_delete.php', { id })
        .then(response => {
          if (response.data.success) {
  ...
  const insertar = () => {
    if (form.nombre && form.precio && form.image_url) {
      axios.post('http://localhost/refresco_create.php', form)
        .then(response => {
          if (response.data.success) {
  ...
  const generatePDF = () => {
    axios.post('http://localhost/generar_pdf_refresco.php', { data: dataState }, { responseType: 'blob' })
      .then(response => {
...
export default RefrescoProfile;
