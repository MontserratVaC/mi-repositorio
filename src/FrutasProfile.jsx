...
const FrutasProfile = () => {
  ...
  const editar = () => {
    axios.post('http://localhost/frutas_update.php', form)
      .then(response => {
  ...
  const eliminar = (id) => {
    ...
    if (opcion) {
      axios.post('http://localhost/frutas_delete.php', { id })
        .then(response => {
          if (response.data.success) {
  ...
  const insertar = () => {
    if (form.nombre && form.precio && form.image_url) {
      axios.post('http://localhost/frutas_create.php', form)
        .then(response => {
          if (response.data.success) {
  ...
  const generatePDF = () => {
    axios.post('http://localhost/generar_pdf_frutas.php', { data: dataState }, { responseType: 'blob' })
      .then(response => {
